...
class InceptionResNetV2(nn.Module):
    ...
    def __init__(self, num_classes=1001, gray = None, img_size = 224):
...
def inceptionresnetv2(num_classes=1000, pretrained='imagenet', classes = 1000, **kwargs):
    ...
    if pretrained:
        ...
        model = InceptionResNetV2(num_classes=1001, **kwargs)
    # modify
    model.last_linear = nn.Linear(1536,classes)
